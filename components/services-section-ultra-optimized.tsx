...
// Componente ultra-optimizado para servicios
function ServicesSectionOptimized() {
  const [services, setServices] = useState<Service[]>([])
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)

  useEffect(() => {
    // Cargar servicios de forma independiente
    ...
    // Delay mínimo para no bloquear el render inicial
    const timer = setTimeout(loadServices, 50)
...
export { ServicesSectionOptimized }
